...
<div class="content">
    ...
    <div id="jquery-accordion-menu" class="jquery-accordion-menu custom">
        ...
        <ul id="demo-list">
            <li><a href="/reserve/admin" target="main"><i class="fa fa-location-arrow"></i>我的预定</a></li>
            <li><a href="/park/admin" target="main"><i class="fa fa-location-arrow"></i>我的创建</a></li>
            ...
            <li><a href="/admin/getFromSession" target="main"><i class="fa fa-briefcase"></i>我的信息</a></li>
