...
<div class="main">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" action="/admin/update" class="form-horizontal" style="margin: 0 auto;width: 60%;border: 1px #ffffff">
                <input type="hidden" name="id" value="${user.id}" />
                <dl class="dl-horizontal">
                    <dt>用户名:</dt>
                    <dd><input type="text" name="adminName" value="${user.adminName!}" style="width: 300px"></dd>
                </dl>

                <dl class="dl-horizontal">
                    <dt>用户密码:</dt>
                    <dd><input type="text" name="adminpwd" value="${user.adminpwd!}" style="width: 300px"></dd>
                </dl>
